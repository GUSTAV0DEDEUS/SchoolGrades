<%-- 
    Document   : signup
    Created on : May 1, 2024, 7:06:44 PM
    Author     : samuel
--%>
...
<head>
    ...
    <title>Criar Usuário | Academic</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-200 h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
        <h1 class="text-3xl font-bold mb-6 text-center">Criar Usuário</h1>
        <form action="./persist/criarUsuario.jsp" method="post">
            <div class="mb-4">
            ...
            <div class="flex items-center justify-center">
                <input type="submit" value="Criar Usuário" class="bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600">
            </div>
        </form>
    </div>
</body>
