...
<body class="bg-gray-200 h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex items-center justify-center">
            <a href="../CYA.jsp" class="bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600">Voltar para a página inicial</a>
        </div>
    </div>
</body>
</html>
